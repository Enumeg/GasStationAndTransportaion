...
{
    /// <summary>
    /// Interaction logic for Gas_Page_EN.xaml
    /// </summary>
    public partial class Gas_Page_EN : Page
    {
        object GasId = null;
        ...
        private void Get_Cement_Prices()
        {
            try
            {
                ...
                db2.AddCondition("ctp_per_id", null, false, " is ");
        ...
        private void add_update_outcome_Save(object sender, EventArgs e)
        {
            try
            {
                ...
                if (Notify.validate("Please Enter Gas Name", Gas_TB.Text, Station.GetWindow(this)))
                {
                    return;
                }
